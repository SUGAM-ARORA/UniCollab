...
const features = [
  {
    ...
    about:
      "I'm a versatile professional skilled in web design and user experience, creating intuitive and visually appealing interfaces that enhance user interaction.",
  ...
  },
  {
    ...
    about:
      "I'm a versatile professional skilled in front-end development and graphic design, crafting visually compelling and user-friendly web interfaces.",
  ...
  },
  {
    ...
    github: "https://github.com/saketh-05/To-Do-List",
    role: "Back-End Developer, Database Administrator",
    about:
      "I'm a versatile professional skilled in back-end development and database administration, ensuring efficient server-side operations and data management.",
  ...
  },
  {
    ...
    about:
      "I'm a versatile professional skilled in Mobile App development and database administration, ensuring efficient server-side operations and data management.",
  ...
  },
  {
    ...
    about:
      "I'm a creative professional with expertise in graphic design and illustration, dedicated to bringing visual concepts to life through innovative and artistic solutions.",
  ...
  },
  {
    ...
    about:
      "I'm a game developer and animator passionate about creating immersive and engaging gaming experiences. My expertise spans game design, development, and animation, bringing virtual worlds to life.",
  ...
  },
  {
    ...
    about:
      "I'm a full stack developer and cloud specialist, skilled in both client-side and server-side development. My expertise includes deploying applications on cloud platforms and ensuring they are scalable and efficient.",
  ...
  },
  {
    ...
    about:
      "I'm a web developer and content strategist, focused on building websites that are not only functional but also content-rich and user-friendly. I ensure that the website's structure and content align with user needs and business goals.",
  ...
  },
  {
    ...
    about:
      "I'm a back-end developer and API integrator, specializing in creating secure and efficient server-side logic and integrating third-party APIs. My work ensures that web and mobile applications have reliable back-end support.",
    text: "AIimage is a comprehensive platform designed to streamline inventory management and enhance supply chain efficiency for businesses of all sizes. It offers a user-friendly interface with robust features that cater to the diverse needs of retail, manufacturing, and e-commerce sectors. Key functionalities include real-time inventory tracking, automated restocking alerts, and detailed analytics for informed decision-making. StockIT integrates seamlessly with existing ERP and accounting systems, ensuring smooth data flow across various business operations. With advanced reporting tools, businesses can monitor stock levels, forecast demand, and minimize the risks of overstocking or stockouts. StockIT's cloud-based solution provides secure access from any device, enabling teams to manage inventory on the go. Dedicated customer support and regular software updates ensure that users have the latest tools to maintain optimal inventory levels and maximize profitability.",
  },
];

function CardMain() {
  return <Cardcontainer features={features} />;
}
